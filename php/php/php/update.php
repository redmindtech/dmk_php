...
if($mode==0)
{
    ...
    $sql = "UPDATE  user_master SET firstname = $firstname, lastname=$lastname, designation' = $designation,party_designation = $party_designation,email = $email,'approval_status' = $status_approval where user_maser_id =  $user_id";
